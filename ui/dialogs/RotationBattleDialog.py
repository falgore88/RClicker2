...
################################################################################
## Form generated from reading UI file 'RotationBattleDialog.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gid.addWidget(self.label_3, 1, 2, 1, 1)
        ...
        self.gid.addWidget(self.abilityTimeoutField, 1, 3, 1, 1)

        self.label_4 = QLabel(Dialog)
        self.label_4.setObjectName(u"label_4")

        self.gid.addWidget(self.label_4, 1, 4, 1, 1)
        ...
        self.gid.addWidget(self.globalTimeoutField, 1, 5, 1, 2)
        ...
        self.gid.addWidget(self.rotationNameTextField, 0, 1, 1, 6)
